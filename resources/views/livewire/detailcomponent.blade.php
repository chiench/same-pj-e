                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    <div class="wrap-product-detail">
                        <div class="detail-media">
                            <div wire:ignore class="product-gallery">
                                <ul class="slides">
                        ...
                        <div class="detail-info">
                            ...
                            <div class="wrap-butons">
                                ...
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$proDetails->id}},'{{$proDetails->name}}', {{$proDetails->regular_price}})">Add to Cart</a>
                                <div class="wrap-btn">
                        ...
                        <div class="advance-info">
                            ...
                            <div class="tab-contents">
                                <div class="tab-content-proDetails active" id="description">
                                    <p>{{$proDetails->short_description}}</p>
                                    <p>{{$proDetails->short_description}} </p>
