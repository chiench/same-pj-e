                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a name="" id="" class="btn btn-sm btn-primary" href="{{route('admin_product_edit',['product_slug' =>$d->slug])}}" role="button">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a name="" id="" class="btn btn-sm btn-danger btndelete" wire:click.prevent='dele({{$d->id}})' href="" role="button">
