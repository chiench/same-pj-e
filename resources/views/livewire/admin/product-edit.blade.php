        ...
        <div class="container" style="padding: 30px 0 ;">
          ...
          <div class="row">
              ...
              <div class="col-md-12">
                ...
                <form action="{{route('admin_product_add')}}" wire:submit.prevent='updatePro' enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input style="height: 40px" wire:model='Regular_price' name="Regular_price" id="Regular_price" type="text" value="" class="form-control"  aria-describedby="helpId" placeholder="...">
                                @error('slug')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                              </div>
                        ...
                        <div class="form-group">
                            ...
                            <input style="height: 40px" wire:model='newimage' type="file" value="" class="file-input">
                           @if ($newimage)
                           <img src="{{$image->temporaryUrl()}}" style="width: 120; height: 100px;" alt="">
                           @else
                           <img src="/file/images/products/{{$image}}" style="width: 120; height: 100px;">                           @endif
                          </div>
