                            ...
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-wish">
                                        @if ($wish->contains($item->id))
                                        <a href="" wire:click.prevent="removeformwish({{$item->id}})"><i class="fa fa-heart fill-heart"></i></a>
                                        @else
                                        <a href="" wire:click.prevent="addwish({{$item->id}},'{{$item->name}}', {{$item->regular_price}})"><i class="fa fa-heart"></i></a>
                                        @endif
                ...
                <div class="widget mercado-widget categories-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-category">
                            ...
                            <li class="category-item {{count($item->subcat) > 0 ? 'has-child-cate':''}}" >
                                <div>
                                    ...
                                    @if(count($item->subcat)> 0)
                                        ...
                                        <ul class="sub-cate">
                                            ...
                                            <li class="category-item">
                                                <a href="{{route('product_category',['category_slug'=>$item->slug,'scategory_slug'=>$sub->slug])}}" class="cat-link"><i class="fa fa-caret-right"></i>
                                                    {{$sub->name}}
                                                </a>
                                            </li>
                                            @endforeach
                ...
                <div class="widget mercado-widget filter-widget price-filter">
                    ...
                    <div class="widget-content">
                        ...
                        <p>
                            ...
                            <input type="text" wire:model='min' name="minval" id="amount1" />
                            <input type="text" wire:model='max' name="maxval" id="amount2" />
...
// alert(minPrice);
@this.call('update',minPrice,maxPrice);
}
</script>
@endpush
