...
use App\Http\Livewire\Wishlistmain;
...
Route::get('/product_category/{category_slug}/{scategory_slug?}',Categorycomponent::class)->name('product_category');

Route::get('/search',Searchcomponent::class)->name('product_search');

Route::get('/product_fillter',Select::class)->name('product_fillter');
Route::get('/wishlist',Wishlistmain::class)->name('product_wish');
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/category/{category_slug}/{scategory_slug?}',CategoryEdit::class)->name('admin_category_edit');

    Route::get('/product',Productall::class)->name('admin_product');
    Route::get('/product/add',ProductAdd::class)->name('admin_product_add');
    Route::get('/product/{product_slug}',ProductEdit::class)->name('admin_product_edit');
...
Route::middleware(['auth:sanctum', 'verified'])->group(function (){
    ...
    Route::get('profile',App\Http\Livewire\User\UserProfile::class)->name('UserProfile');
    Route::get('profile/edit',App\Http\Livewire\User\UserProfileEdit::class)->name('UserProfileEdit');
